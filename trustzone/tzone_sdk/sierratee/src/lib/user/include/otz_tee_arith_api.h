...
typedef sw_uint TEE_BigInt;
typedef sw_uint TEE_BigIntFMM;
typedef sw_uint TEE_BigIntFMMContext;
 ...
 * @param op2
 */
void TEE_BigIntExtendedGcd(TEE_BigInt* gcd, TEE_BigInt* u, TEE_BigInt* v,
		TEE_BigInt* op1, TEE_BigInt* op2);
