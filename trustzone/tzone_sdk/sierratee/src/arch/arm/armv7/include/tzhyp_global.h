...
#endif
extern sw_uint tzhyp_nsadmin_start, tzhyp_nsadmin_end;

/**
 * @brief 
 */
extern sw_uint kernel_start, kernel_end;

/**
 * @brief 
 */
extern sw_uint kernel_2_start, kernel_2_end;

/**
 * @brief 
 */
extern sw_uint initrd_image_start, initrd_image_end;
