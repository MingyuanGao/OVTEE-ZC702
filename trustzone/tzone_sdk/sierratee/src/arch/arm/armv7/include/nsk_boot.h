 ...
 *
 * When a linux image is loaded, this will contain the information needed.
 *
 */
...
struct nsk_boot_info {
	sw_uint nskbi_srcaddr; 
	sw_uint nskbi_loadaddr;
	sw_uint nskbi_size;
	int nskbi_initrd_flag;  /* Setting this flag loads initrd */
	sw_uint nskbi_initrd_sa;
	sw_uint nskbi_initrd_la;
	sw_uint nskbi_initrd_size;
};
