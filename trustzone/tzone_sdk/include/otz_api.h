...
/** @defgroup tzapi TrustZone Linux Client API
 *  Adheres to ARM TrustZone API
 *  @{
 */
...
struct otz_shared_mem_t
{
	 ...
	 *   A structure in this state must not be used unless explicitly specified,
	 ...
	 * data sharing. 
	 * Note that these access flags cannot usually be enforced by the hardware.
	 * If a client or a service ignores the flags specified for a shared memory
	 * block, or a corresponding memory reference, UNDEFINED behavior results. 
